...
// use ensemble01\LaboBundle\Entity\baseRepository;
...
class UserRepository extends EntityRepository {
	...
	*/
	 ...
	 * si $version n'est pas précisé, recherche la version par défaut dans l'entité ensemble01\LaboBundle\Entity\version
	 * @param string $version
	 * @param string $shutdown
	 */
	// public function setVersion($version = null, $shutdown = null) {
	// 	if($version === null) {
	// 		$ver = $this->_em->getRepository("ensemble01LaboBundle:version")->defaultVersion();

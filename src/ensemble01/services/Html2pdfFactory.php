...
use Ensepar\Html2pdfBundle\Factory\Html2pdfFactory as HtPF;
use ensemble01\services\HTML2PDFextended;

/**
 * Creates HTML2PDF instances.
 */
class Html2pdfFactory extends HtPF {
    private $mode;
    private $format;
    private $lang;
    private $unicode;
